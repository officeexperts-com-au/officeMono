...
## H1: Microsoft Office and SQL Server Integration

### H2: Custom Solutions for Office

### H2: More Custom Solutions
...
We can setup custom solutions for you in Access, Excel, Word and Visual Studio which can modify and extract data from SQL Server databases. For example:

Our experts can also build solutions including:
...
We can give you a quote or work to an hourly rate. Via remote access, we offer ongoing support and training, for your staff to learn specific tasks as needed.
