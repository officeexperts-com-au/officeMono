    ...
    <main>
      ...
      <ul>
        <li>
          ...
          provided by Office Experts Group to the Customer, as described in the
          Quote provided to the Customer.
        </li>
        <li>
          ...
          <ul>
            ...
            <li>
              ...
              negotiation and implementation of these Terms and the provision of
              the Services;
            </li>
            <li>
              (c) Intellectual Property Rights, trade secrets, inventions, mask
              works, ideas, processes, formulas, source and object codes, data,
              programs, other works of authorship, know-how, improvements
              (including without limitation improvements in process),
              discoveries, developments, drawings, designs and techniques;
            </li>
            <li>
        ...
        <li>
          <strong>Customer Premises</strong> means the business premises of the
          Customer from time to time.
        </li>
        <li>
          <strong>Expenses</strong> means any out-of-pocket expenses incurred by
          Office Experts Group in providing the Services, including without
          limitation all travel accommodation and other expenses.
        </li>
        <li>
          <strong>Fee Estimate</strong> has the meaning given by clause 7.1(a).
        </li>
        <li>
        ...
        <li>
          <strong>Intellectual Property Rights</strong> has the meaning given by
          clause 18.1.
        </li>
        <li>
        ...
        <li>
          ...
          requirement under any statute, regulation or by-law, any condition of
          any authorisation and any decision, directive, guideline or
          requirement of a government agency which is relevant to the provision
          of the Services under these Terms.
        </li>
        <li>
          <strong>Services</strong> means some or all of the services which are
          to be provided by Office Experts Group to the Customer pursuant to
          these Terms.
        </li>
        <li>
        ...
        <li>
          <strong>Up-Front Payment</strong> has the meaning given by clause 7.2
          of the Terms.
        </li>
      </ul>
      ...
      <ul>
        ...
        <li>
          ...
          instruments under it and any variation or replacement of any of them.
        </li>
        <li>
        ...
        <li>
          (e) References to any instrument are to that instrument as it may from
          time to time be amended or extended in accordance with its terms.
        </li>
        <li>
      ...
      <p>
        Office Experts Group and the Customer agree that these Terms are binding
        on their legal personal representative, heirs, successors and permitted
        assigns.
      </p>
      ...
      <p>
        Office Experts Group accepts its appointment to provide the Services in
      ...
      <p>
        3.1 (Commencement) Unless expressly stated otherwise in these Terms, the
        rights and obligations created under these Terms commence on, and are
        enforceable from, the date on which these Terms are signed by the
        Customer, or the date on which Office Experts Group start providing the
        Services.
      </p>

      <p>
        3.2 (Term) These Terms will continue in full force and effect until they
        are terminated by Office Experts Group or the Customer.
      </p>
      ...
      <ul>
        <li>
          ...
          Group to be provided with reasonable access (including remote access)
          to the Customer Premises or systems when required; and
        </li>
        <li>
      ...
      <p>
        ...
        facilitate Office Experts Group providing the Services to the Customer,
        including without limitation, signing or executing any documents or
        declarations reasonably requested by Office Experts Group in order to
        ensure that Office Experts Group can continue to provide the Services.
      </p>
      ...
      <p>
        ...
        Group may provide a Quote for the provision of Services. The Quote will
        be prepared having regard to the Proposed Scope. The Quote may be either
        (at the discretion of Office Experts Group):
      </p>
      <ul>
        <li>
        ...
        <li>
          ...
          Scope (Fixed Price Quote). Office Experts Group agrees to cap its fees
          for the provisions of the Services at the Fixed Price Quote amount,
          unless there is any change to the Proposed Scope.
        </li>
      </ul>

      <p>
        7.2 (Up Front Payment) Office Experts Group may request the Customer to
        pay 50% of the Fee Estimate or Fixed Price Quote to Office Experts Group
        prior to commencement of the Services (Up Front Payment). If such a
        request is made, the Customer acknowledges that Office Experts Group
        will not commence provision of the Services until Office Experts Group
        has received the Up Front Payment.
      </p>
      ...
      <p>
        ...
        Customer must pay the invoice within 30 days of issue. Invoices will be
        communicated via email unless otherwise agreed.
      </p>
      ...
      <p>
        ...
        details of the dispute (Notification). Office Experts Group will review
        and consider the Notification, and may, in Office Experts’ discretion,
        either:
      </p>
      <ul>
        <li>
      ...
      <ul>
        ...
        <li>
          ...
          Group will be included in the invoices issued to the Customer pursuant
          to clause 7.3.
        </li>
      </ul>
      ...
      <p>
        ...
        required payment time (Overdue Amount) then Office Experts Group may, in
        its sole discretion:
      </p>
      <ul>
        <li>
      ...
      <p>
        ...
        disadvantage or harm that you may suffer as a result of us deciding not
        to continue to perform any further work for the Customer in accordance
        with clause 7.6.
      </p>

      <p>
        7.7 (Information to debt collectors) If we need to take action against
        you for an Overdue Amount, we may disclose to our debt collection agents
        any personal information that they reasonably request in order to
        recover the Overdue Amount (and any interest) from the Customer.
      </p>
      ...
      <ul>
        <li>
          ...
          the amount of any payment in connection with the Supply multiplied by
        ...
        <li>
          ...
          all of the requirements of the GST Act prior to any obligation arising
          on the Recipient to pay the consideration for a Taxable Supply.
        </li>
        <li>
        ...
        <li>
          ...
          under these Terms changes because of an Adjustment Event, the parties
          must do all things necessary to ensure that the Adjustment Event is
          appropriately recognised, including the issue of an Adjustment Note if
          required under the GST Act.
        </li>
        <li>
          (e) (Meaning of Key Terms): Capitalised terms used in this clause that
          are not otherwise defined in these Terms have the meaning given in the
          GST Act.
        </li>
      </ul>
      ...
      <h2>8 WARRANTY</h2>
      <p>
        8.1 Office Experts Group warrants that it will take all reasonable care
        and diligence to ensure the Services are provided to the Service
        Standard.
      </p>
      ...
      <p>
        9.1 Subject to law, Office Experts Group’s liability to the Customer in
        respect of the Services is limited to the total amount invoiced to the
        Customer in respect of the relevant Services.
      </p>

      <p>
        9.2 Office Experts will not be liable for any damage or loss incurred by
        the Customer where such damage or loss is caused by the Customer.
      </p>

      <p>
        9.3 Office Experts Group will not be liable where the Customer incurs
        loss due to a suspension of services by Office Experts Group caused by a
        failure of the Customer to pay any amount to Office Experts Group when
      ...
      <p>
        ...
        loss or damage that is attributable to the negligent or reckless act or
        omission, or wilful misconduct, of Office Experts Group or its officers
        and employees (including any breach of these Terms by Office Experts
        Group).
      </p>

      <p>
        10.3 (Survival): The provisions of this clause 10 survive termination of
        these Terms.
      </p>

      <h2>11 PRIVACY AND CREDIT CHECKS</h2>
      <p>
        11.1 (Privacy): Office Experts Group is bound by the privacy principles
        contained under the Privacy Act 1988 (Cth). Office Experts Group’s
        privacy policy is available at its website{" "}
        ...
        with the consent of the person to whom it relates. Office Experts Group
        may use and disclose this information as required in relation to the
        Services that we provide, and in accordance with the privacy policy.
      </p>
      ...
      <p>
        ...
        discretion, liaise with third party providers to obtain a credit search
        and credit history of the Customer. The Customer agrees to cooperate
        with Office Experts Group in respect of any such credit check.
      </p>
      ...
      <p>
        ...
        to these Terms if the Customer would like to do so. Office Experts Group
        recommends that the Customer obtain such independent advice.
      </p>
      ...
      <p>
        ...
        Experts Group agrees to take all reasonable steps to resolve any dispute
        to the Customer’s satisfaction.
      </p>

      <h2>16 RECORDS</h2>
      <p>
        16.1 (Records): The Customer must keep such information and material in
        respect of the Services from time to time to ensure that Office Experts
        Group can satisfy its obligations under these Terms and pursuant to
        Relevant Law.
      </p>
      ...
      <ul>
        <li>
          (a) treat all Confidential Information as secret and confidential and
          not use such Confidential Information for any unauthorised purpose;
        </li>
        <li>
          (b) not disclose any Confidential Information to any person other than
          an employee or agent or sub-contractor who requires that information
          to effectively perform their respective duties, who are aware the
          information is confidential, and who are bound to treat it as such;
        </li>
        <li>
          (c) ensure that it complies with any separate confidentiality
          agreements or undertakings entered into with the Customer from time to
          time; and
        </li>
        <li>
          (d) not use any Confidential Information for its own purposes, or for
          the benefit of any third party, except as expressly authorised by the
          Customer.
        </li>
      </ul>

      <p>
        17.2 (Exception): Nothing in this clause 17 prevents the Office Experts
        Group from disclosing Confidential Information:
      </p>
      <ul>
        <li>
        ...
        <li>
          (c) to the extent that disclosure is required to perform the Services
      ...
      <p>
        17.3 (Survival): The provisions of this clause 17 will continue to apply
        notwithstanding that these Terms have come to an end.
      </p>
      ...
      <ul>
        ...
        <ul>
          <li>
            ...
            formulae, methods of production, inventions, innovations, know-how,
            confidential information, database rights, and rights in trade marks
        ...
        <li>
          ...
          graphic works of any type, and other materials in any medium or format
          which are created by or on behalf of Office Experts Group in the
          course of performing the Services and which are protected or relate to
      ...
      <p>
        ...
        ownership of all Intellectual Property Rights which exist or which arise
        (whether through creation, authorship, production, evolution, discovery,
        development or invention) in the process of performing the Services.
      </p>

      <p>
        18.3 (Third Party Rights): The Customer represents and warrants that it
        will not infringe the Intellectual Property Rights of any third party in
        requesting Office Experts Group to perform the Services. The Customer
        indemnifies Office Experts Group for any loss, damage or expense
        suffered or incurred by Office Experts Group as the result of any claim
        that the items serviced by Office Experts Group at the request of the
        Customer infringe the Intellectual Property Rights of any person.
      </p>

      <p>
        18.4 (Survival): The provisions of this clause 18 survive termination of
        these Terms.
      </p>
      ...
      <p>
        ...
        unenforceable in a particular jurisdiction, may be read down or severed
        to the extent of the invalidity or unenforceability in that jurisdiction
        only. The invalidity or unenforceability of a provision of these Terms
        in one jurisdiction does not affect the:
      </p>
      <ul>
        <li>
      ...
      <p>
        19.3 (Costs): Each party must bear its own costs in respect of the entry
        into and negotiation of these Terms.
      </p>
      ...
      <p>
        19.6 (Cumulative): The rights, remedies and powers of the parties under
        these Terms are cumulative and not exclusive of any rights, remedies or
      ...
      <p>
        ...
        withheld, given conditionally, or given unconditionally, in each case in
        the relevant party’s absolute discretion.
      </p>
      ...
      <p>
        ...
        laws in force in the State of New South Wales and the parties submit to
        the exclusive jurisdiction of the Supreme Court of New South Wales to
        decide any dispute between them in relation to these Terms.
      </p>
      ...
      <ul>
        <li>
          (a) Microsoft Office design, construction, maintenance and support of
