...
export const metadata = {
  ...
  description: "Professional Office 365 migration services with no downtime or data loss. Expert migration of emails, files, and systems to Office 365.",
  
  // OpenGraph
  openGraph: {
    title: "Office 365 Migration Services",
    description: "Seamless Office 365 migration services for emails, files and systems with zero downtime and data loss protection.",
  ...
  themeColor: "#ffffff",
  canonical: "https://www.officeexperts.com.au/services/microsoft-office-365/office-365-migration/",
  robots: {
    index: true,
    follow: true,
