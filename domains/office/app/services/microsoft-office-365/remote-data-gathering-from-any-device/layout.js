...
export const metadata = {
  ...
  description: "Professional Office 365 implementation and migration services. Expert consultants for successful Office 365 deployment across your organization.",
  
  openGraph: {
    title: "Microsoft Office 365 Implementation Services",
    description: "Expert Office 365 implementation services for businesses of all sizes. Seamless migration and deployment solutions.",
  ...
  themeColor: "#ffffff",
  canonical: "https://www.officeexperts.com.au/services/microsoft-office-365/office-365-implementation/",
  robots: {
    index: true,
    follow: true,
