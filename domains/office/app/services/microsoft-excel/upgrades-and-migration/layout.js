...
export const metadata = {
  ...
  description: "Expert Microsoft Excel migration and upgrade services. We help resolve Excel workbook issues, optimize performance, and ensure smooth transitions between versions.",
  
  // OpenGraph
  openGraph: {
    title: "Excel Upgrades and Migration Services",
    description: "Professional Excel migration and upgrade services. Resolving workbook issues, version compatibility, and performance optimization.",
  ...
  themeColor: "#ffffff",
  canonical: "https://www.officeexperts.com.au/services/microsoft-excel/upgrades-and-migration/",
  robots: {
    index: true,
    follow: true,
