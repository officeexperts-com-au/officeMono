...
const schema = [
  {
    ...
    description:
      "Professional Microsoft Office consulting services specializing in VBA macro development and automation solutions across Australia.",
    areaServed: [
      {
        "@type": "Country",
        name: "Australia",
