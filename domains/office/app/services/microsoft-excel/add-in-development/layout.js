...
export const metadata = {
  ...
  description: "Expert Excel add-in development services for extending Excel functionality. Specializing in VBA and VSTO add-ins to automate tasks and enhance Excel capabilities.",
  ...
  themeColor: "#ffffff",
  canonical: "https://www.officeexperts.com.au/services/microsoft-excel/add-in-development/",
  robots: {
    index: true,
    follow: true,
