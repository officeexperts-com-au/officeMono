...
export const metadata = {
  ...
  description: "PowerPoint experts providing data linking and VBA automation solutions for PowerPoint presentations. Professional automation services for time-saving and accuracy.",
  
  // OpenGraph
  openGraph: {
    title: "PowerPoint VBA Automation Services",
    description: "Expert PowerPoint automation services linking your data directly to presentations, saving time and ensuring accuracy with VBA solutions.",
  ...
  themeColor: "#ffffff",
  canonical: "https://www.officeexperts.com.au/services/microsoft-powerpoint/automate-presentations-with-vba/",
  robots: {
    index: true,
    follow: true,
